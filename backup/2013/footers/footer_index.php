        ...
        <script src="<?php echo $myv_host; ?>//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
        <script>window.jQuery || document.write('<script src="<?php echo $myv_host; ?>/js/jquery-1.9.1.min.js"><\/script>')</script>
		<script type="text/javascript" src="<?php echo $myv_host; ?>/js/jquery.scrollTo.min.js"></script>
		<script type="text/javascript" src="<?php echo $myv_host; ?>/js/jquery.easing.min.js"></script>

        <script src="<?php echo $myv_host; ?>/js/bootstrap.min.js"></script>

        <script src="<?php echo $myv_host; ?>/js/main.js"></script>
		<script src="<?php echo $myv_host; ?>/js/jquery.masonry.min.jsa"></script>
		<script src="<?php echo $myv_host; ?>/js/packery.pkgd.min.jsa"></script>
		<script src="<?php echo $myv_host; ?>/js/jquery.isotope.min.js"></script>
		<script src="<?php echo $myv_host; ?>/js/jquery.cycle.lite.js"></script>
		<script src="<?php echo $myv_host; ?>/js/jquery.client.js"></script>
